...
int main() {
    std::cout << "=================================================================" << std::endl;
    std::cout << "--- WORKBOOK: Arenas & Placements (Problems 51-55) ---" << std::endl;
    std::cout << "=================================================================" << std::endl;
  ...
  // P55: Custom Arena Reset
  {
    char pool[1024];
    char *pool_ptr = pool + 256;
    // TODO: Reset / deallocate all memory from the pool by resetting pool_ptr
    // back to pool

    bool ok = (pool_ptr == pool);
    reportStatus("Problem 55: Arena allocator reset", ok);
    if (ok)
      passed++;
    total++;
  }
    ...
    std::cout << "\n=================================================================" << std::endl;
    std::cout << "--- SCORECARD: Arenas & Placements ---" << std::endl;
    std::cout << "=================================================================" << std::endl;

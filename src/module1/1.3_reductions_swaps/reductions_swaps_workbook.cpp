...
int main() {
    std::cout << "=================================================================" << std::endl;
    std::cout << "--- WORKBOOK: Array Reductions & Swaps (Problems 11-15) ---" << std::endl;
    std::cout << "=================================================================" << std::endl;
  ...
  // P15: Swap values using pointers
  {
    int x = 5, y = 10;
    // TODO: Swap x and y using pointers (do not use std::swap)

    bool ok = (x == 10 && y == 5);
    reportStatus("Problem 15: Swap two variables using pointers", ok);
    if (ok)
      passed++;
    total++;
  }
    ...
    std::cout << "\n=================================================================" << std::endl;
    std::cout << "--- SCORECARD: Array Reductions & Swaps ---" << std::endl;
    std::cout << "=================================================================" << std::endl;

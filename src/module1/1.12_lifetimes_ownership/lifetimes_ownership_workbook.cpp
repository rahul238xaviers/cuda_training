...
int main() {
    std::cout << "=================================================================" << std::endl;
    std::cout << "--- WORKBOOK: Lifetimes, Ownership & Resize (Problems 56-60) ---" << std::endl;
    std::cout << "=================================================================" << std::endl;
  ...
  // P60: Memory Leak Simulator
  {
    int leak_count = 1;
    int *ptr = new int(10);
    // TODO: Avoid memory leak by freeing ptr and decrementing leak_count

    bool ok = (leak_count == 0);
    reportStatus("Problem 60: Memory leak prevention", ok);
    if (ok)
      passed++;
    total++;
  }
    ...
    std::cout << "\n=================================================================" << std::endl;
    std::cout << "--- SCORECARD: Lifetimes, Ownership & Resize ---" << std::endl;
    std::cout << "=================================================================" << std::endl;
